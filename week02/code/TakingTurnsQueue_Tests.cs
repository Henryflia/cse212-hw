...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The error was in Person Cs; enqueue was working in reverse.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Those with infinite turns were removed the first time and not added back.
    ...
    // Defect(s) Found: If it was negative, it wasn't considered infinite, so to make it work, I had to specify that numbers less than 0 also counted as infinite turns.
